package top.qjj.shmily.lineage.utils;

/**
 * @author 佳境Shmily
 * @Description: Http Utils
 * @CreateTime: 2023/7/29 12:05
 * @Site: shmily-qjj.top
 */
...
public class HttpClient {
        ...
        try {
            ...
            if (null != br) {
                try {
                    ...
                    log.warn("err:{} url:{}", e.getMessage(), httpurl, e);
                }
            }
            if (null != is) {
                try {
    ...
    public static String doPost(String httpUrl, String param, HashMap<String,String> requestProperties) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Aa aa = new Aa("1", "qjj");
        LineageMsg msg = new LineageMsg("test", gson.toJson(aa));
        String s = HttpClient.doPost(url, gson.toJson(msg), new HashMap<>(0));
